...
public interface Constants {
    ...
    final String TAG = "Impel Notes";
    final String DATABASE_NAME = "impel-notes";
    ...
    final String DEV_EMAIL = "test@gmail.com";

    // Used for updates retrieval
    final String PS_METADATA_FETCHER_URL = "";
    final String PLAY_STORE_URL = "";
    static long UPDATE_MIN_FREQUENCY = 24 * 60 * 60 * 1000; // 1 day
    final String DRIVE_FOLDER_LAST_BUILD = "";
