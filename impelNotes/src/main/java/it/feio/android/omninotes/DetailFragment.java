...
//					((View)event.getLocalState()).setVisibility(View.VISIBLE);
    ...
    private void trashNote(boolean trash) {
        ...
        if (trash) {
            ShortcutHelper.removeshortCut(ImpelNotes.getAppContext(), noteTmp);
            ReminderHelper.removeReminder(ImpelNotes.getAppContext(), noteTmp);
        } else {
    ...
    public void onNoteSaved(Note noteSaved) {
        MainActivity.notifyAppWidgets(ImpelNotes.getAppContext());
    ...
    private void addShortcut() {
        ShortcutHelper.addShortcut(ImpelNotes.getAppContext(), noteTmp);
